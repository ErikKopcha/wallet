import {Modal, Typography, Box, Switch, Stack, ButtonGroup, Button, Grid, TextField, Select, MenuItem, InputLabel} from '@mui/material';
  ...
  return (
    ...
    >
      <div className={style.box}>
        ...
        <Stack sx={{mt: '50px'}}>
          <Button variant='contained' sx={{color: '#fff', mb: '20px'}}>Add</Button>
